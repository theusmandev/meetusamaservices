...
__export(stdin_exports, {
  default: () => RefundPolicyPage
});
module.exports = __toCommonJS(stdin_exports);
var import_page_hero = require("../components/page-hero");
var import_ScrollReveal = require("../components/ScrollReveal");
var import_lucide_react = require("lucide-react");
function RefundPolicyPage() {
  return <>
      <import_page_hero.PageHero
    eyebrow="Legal"
    title="Refund Policy"
    subtitle="Last Updated: July 17, 2026"
  />
      <section className="bg-background py-16 md:py-24">
        <import_ScrollReveal.ScrollReveal>
    ...
    /* ── Section 1 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.Briefcase className="h-6 w-6 text-[color:var(--gold)]" />
            ...
            <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-6 md:p-8">
              ...
              <ul className="mt-4 space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <import_lucide_react.CheckCircle2 className="mt-0.5 h-5 w-5 shrink-0 text-emerald-500" />
    ...
    /* ── Section 3 ── */
            ...
            <div className="rounded-2xl border border-red-500/20 bg-red-500/5 p-6 md:p-8">
              ...
              <ul className="mt-4 space-y-3 text-muted-foreground">
                <li className="flex items-start gap-3">
                  <import_lucide_react.XCircle className="mt-0.5 h-5 w-5 shrink-0 text-red-500" />
    ...
    /* ── Section 4 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.Building2 className="h-6 w-6 text-[color:var(--gold)]" />
    ...
    /* ── Section 5 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.Wallet className="h-6 w-6 text-[color:var(--gold)]" />
    ...
    /* ── Section 6 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.Clock className="h-6 w-6 text-[color:var(--gold)]" />
    ...
    /* ── Section 7 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.CalendarClock className="h-6 w-6 text-[color:var(--gold)]" />
    ...
    /* ── Section 8 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.Mail className="h-6 w-6 text-[color:var(--gold)]" />
                Contact Us
              </h2>
              <p className="mt-4 text-muted-foreground">
    ...
    /* ── Section 9 ── */
            ...
            <div className="rounded-2xl border border-border bg-card p-6 md:p-8">
              <h2 className="flex items-center gap-3 font-display text-2xl font-bold">
                <import_lucide_react.CheckSquare className="h-6 w-6 text-[color:var(--gold)]" />
