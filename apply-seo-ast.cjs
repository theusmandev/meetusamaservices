...
const pages = [
  ...
  { path: 'src/pages/services/ShopifyPage.tsx', depth: 2, title: 'Shopify Store Designing | Meet Usama Services', desc: 'End-to-end Shopify launch — theme, products, payments, and shipping — built and configured for you.' },
