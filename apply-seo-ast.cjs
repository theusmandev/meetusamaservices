...
const pages = [
  ...
  { path: 'src/pages/services/PayoneerPage.tsx', depth: 2, title: 'Payoneer Consultancy | Meet Usama Services', desc: 'Payoneer account setup for freelancers and marketplace sellers, handled from application to approval.' },
