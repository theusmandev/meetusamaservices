...
const services = [
  ...
  { icon: FileCheck2, title: "Uk LTD Director Verification", desc: "KYC, KYB, address verification and platform re-verification support.", to: "/services/business-verification" },
];
